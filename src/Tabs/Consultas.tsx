...
export default function Consultas({ navigation }: NavigationProps<'Consultas'>) {
  ...
  const [recaregar, setRecaregar] = useState(false)
  ...
  return (
    <ScrollView p="5">
      ...
      <Botao mt={5} mb={5} onPress={() => navigation.navigate('Agendamento', { especialistaId: especialista.id })}>Agendar nova consulta</Botao>
